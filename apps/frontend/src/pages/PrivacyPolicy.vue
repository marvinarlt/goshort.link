<script setup lang="ts">
  ...
  const legalNoticeUrl = location.origin + '/legal-notice';
</script>

<template>
  <h1>{{ $t('navigation.privacy-policy.label') }}</h1>
  
  <p>Stand: 31. Juli 2022</p>

  <h2>Inhaltsübersicht</h2>
  <ul class="styled">
    <li><a href="#m1870">Einleitung</a></li>
  ...
  <dl class="styled">
    ...
    <dt>Adresse</dt>
    <dd>{{ VITE_LN_STREET }}, {{ VITE_LN_POSTAL }} {{ VITE_LN_CITY }}</dd>

    <dt>E-Mail</dt>
    <dd><a :href="'mailto:' + VITE_LN_MAIL">{{ VITE_LN_MAIL }}</a></dd>

    <dt>Impressum</dt>
    <dd><RouterLink to="/legal-notice" target="_blank">{{ legalNoticeUrl }}</RouterLink></dd>
  </dl>
  ...
  <ul class="styled">
    <li>
      <dl class="styled">
        <dt>Bereitstellung Onlineangebot auf gemietetem Speicherplatz</dt>
        <dd>Für die Bereitstellung unseres Onlineangebotes nutzen wir Speicherplatz, Rechenkapazität und Software, die wir von einem entsprechenden Serveranbieter (auch "Webhoster" genannt) mieten oder anderweitig beziehen</dd>
        <dt>Rechtsgrundlagen</dt>
        <dd>Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO)</dd>
      </dl>
    </li>
    <li>
      <dl class="styled">
        <dt>Erhebung von Zugriffsdaten und Logfiles</dt>
        <dd>Der Zugriff auf unser Onlineangebot wird in Form von so genannten "Server-Logfiles" protokolliert. Zu den Serverlogfiles können die Adresse und Name der abgerufenen Webseiten und Dateien, Datum und Uhrzeit des Abrufs, übertragene Datenmengen, Meldung über erfolgreichen Abruf, Browsertyp nebst Version, das Betriebssystem des Nutzers, Referrer URL (die zuvor besuchte Seite) und im Regelfall IP-Adressen und der anfragende Provider gehören Die Serverlogfiles können zum einen zu Zwecken der Sicherheit eingesetzt werden, z.B., um eine Überlastung der Server zu vermeiden (insbesondere im Fall von missbräuchlichen Angriffen, sogenannten DDoS-Attacken) und zum anderen, um die Auslastung der Server und ihre Stabilität sicherzustellen</dd>
        <dt>Rechtsgrundlagen</dt>
        <dd>Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO)</dd>
        <dt>Löschung von Daten</dt>
        <dd>Logfile-Informationen werden für die Dauer von maximal 30 Tagen gespeichert und danach gelöscht oder anonymisiert. Daten, deren weitere Aufbewahrung zu Beweiszwecken erforderlich ist, sind bis zur endgültigen Klärung des jeweiligen Vorfalls von der Löschung ausgenommen.</dd>
      </dl>
    </li>
    <li>
      <dl class="styled">
        <dt>netcup</dt>
        <dd>Leistungen auf dem Gebiet der Bereitstellung von informationstechnischer Infrastruktur und verbundenen Dienstleistungen (z.B. Speicherplatz und/oder Rechenkapazitäten)</dd>
        <dt>Dienstanbieter</dt>
        <dd>netcup GmbH, Daimlerstraße 25, D-76185 Karlsruhe, Deutschland</dd>
        <dt>Rechtsgrundlagen</dt>
        <dd>Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO)</dd>
        <dt>Website</dt>
        <dd><a href="https://www.netcup.de/" target="_blank">https://www.netcup.de/</a></dd>
        <dt>Datenschutzerklärung</dt>
        <dd><a href="https://www.netcup.de/kontakt/datenschutzerklaerung.php" target="_blank">https://www.netcup.de/kontakt/datenschutzerklaerung.php</a></dd>
        <dt>Auftragsverarbeitungsvertrag</dt>
        <dd><a href="https://www.netcup-wiki.de/wiki/Zusatzvereinbarung_zur_Auftragsverarbeitung" target="_blank">https://www.netcup-wiki.de/wiki/Zusatzvereinbarung_zur_Auftragsverarbeitung</a></dd>
      </dl>
    </li>
  </ul>
  ...
  <h3>Recht auf Löschung und Einschränkung der Verarbeitung</h3>
  <p>Sie haben nach Maßgabe der gesetzlichen Vorgaben das Recht, zu verlangen, dass Sie betreffende Daten unverzüglich gelöscht werden, bzw. alternativ nach Maßgabe der gesetzlichen Vorgaben eine Einschränkung der Verarbeitung der Daten zu verlangen.</p>

  <h3>Recht auf Datenübertragbarkeit</h3>
  <p>Sie haben das Recht, Sie betreffende Daten, die Sie uns bereitgestellt haben, nach Maßgabe der gesetzlichen Vorgaben in einem strukturierten, gängigen und maschinenlesbaren Format zu erhalten oder deren Übermittlung an einen anderen Verantwortlichen zu fordern.</p>
  ...
  <p><a href="https://datenschutz-generator.de/" title="Rechtstext von Dr. Schwenke - für weitere Informationen bitte anklicken." target="_blank" rel="noopener noreferrer nofollow">Generierte Datenschutzerklärung von Dr. Schwenke</a></p>
</template>